                            ...
                            <div class="col-md-6">
                                ...
                                <form role="form" action="MainController" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="txtServiceId" value="${param.txtServiceId}">
                                        <font color="red"> ${requestScope.INVALID.serviceIdError}</font>
                                    </div>

                                    <div class="form-group">
                                        <label>Name</label>
                                        <input class="form-control" name="txtName" value="${param.txtName}">
                                        <font color="red"> ${requestScope.INVALID.serviceNameError}</font>
                                    </div>
                                    <div class="form-group">
                                        <label>Price</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="action" value="InsertService">Add Service</button>
