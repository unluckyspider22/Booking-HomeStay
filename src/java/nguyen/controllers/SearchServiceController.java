...
/**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ServiceDTO> result = dao.findByLikeName(searchValue);
            request.setAttribute("RESULTSEARCHSERVICE", result);
        } catch (Exception e) {
            log("ERROR at SearchServiceController : " + e.getMessage());
        } finally {
            request.getRequestDispatcher("admin_service_manager.jsp").forward(request, response);
        }
    }
