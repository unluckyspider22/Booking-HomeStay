        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
            <div class="row">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Update Drink</li>
                </ol>
            </div><!--/.row-->

            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Drink</h1>
                </div>
            </div><!--/.row-->
            <form>
                            ...
                            <div class="col-md-6">
                                <form role="form" method="POST" action="MainController">
                                    <div class="form-group">
                                        <label>DrinkID</label>
                                        <input class="form-control" name="txtDrinkId" value="${requestScope.DTO.drinkId}" readonly="true">
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
                                    ...
                                    <button type="submit" class="btn btn-primary" name="action" value="UpdateDrink">Update</button>
                                </form>
                            </div>
                        </div>
                    </div><!-- /.col-->
