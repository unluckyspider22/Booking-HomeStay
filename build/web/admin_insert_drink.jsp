                            ...
                            <div class="col-md-6">
                                ...
                                <form role="form" action="MainController" method="POST">
                                    <div class="form-group">
                                        <label>DrinkID</label>
                                        <input class="form-control" name="txtDrinkId" value="${param.txtDrinkId}">
                                        <font color="red"> ${requestScope.INVALID.drinkIdError}</font>
                                    </div>

                                    <div class="form-group">
                                        <label>Name</label>
                                        <input class="form-control" name="txtName" value="${param.txtName}">
                                        <font color="red"> ${requestScope.INVALID.drinkNameError}</font>
                                    </div>
                                    <div class="form-group">
                                        <label>Price</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary" name="action" value="InsertDrink">Add Drink</button>
