...
public class InsertFoodController extends HttpServlet {
    ...
    private static final String INVALID = "admin_insert_food.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(!Pattern.matches(namePattern, foodName)){
                valid = false;
                errorObj.setFoodNameError("Food Name can't be blank and can't contain specific character !!!");
            ...
            if(e.getMessage().contains("duplicate")){
                ErrorObjFood errorObj = new ErrorObjFood();
                errorObj.setFoodIdError("FoodId is existed !!!");
                request.setAttribute("INVALID", errorObj);
                url = INVALID;
            }
        }finally{
