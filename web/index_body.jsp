    ...
    <section class="ftco-booking ftco-section ftco-no-pt ftco-no-pb">
      ...
      <div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
          	<span class="subheading">Welcome to Roxandrea HomeStay</span>
            <h2 class="mb-4">A New Vision of Luxury HomeStay</h2>
          </div>
        </div>  
    				...
    				<div class="room-wrap">
    					<div class="img d-flex align-items-center" style="background-image: url(images/bg_3.jpg);">
    						<div class="text text-center px-4 py-4">
    							<h2>Welcome to <a href="#">Roxandrea</a> HomeStay</h2>
    				...
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
	    						...
	    						<h3 class="mb-3"><a href="index.jsp">Couple Room</a></h3>
	    						<p class="pt-1"><a href="index.jsp" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
    			</div>
    				...
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half right-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
	    						...
	    						<h3 class="mb-3"><a href="index.jsp">Family Room</a></h3>
	    						<p class="pt-1"><a href="index.jsp" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half right-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span></p>
    							<p class="mb-0"><span class="price mr-1">$250.00</span> <span class="per">per night</span></p>
	    						<h3 class="mb-3"><a href="index.jsp">Group Room</a></h3>
	    						<p class="pt-1"><a href="index.jsp" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span></p>
    							<p class="mb-0"><span class="price mr-1">$70.00</span> <span class="per">per night</span></p>
	    						<h3 class="mb-3"><a href="index.jsp">Single Room</a></h3>
	    						<p class="pt-1"><a href="index.jsp" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
    				...
    				<div class="room-wrap d-md-flex">
    					...
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
	    						...
	    						<h3 class="mb-3"><a href="index.jsp">Superior Room</a></h3>
	    						<p class="pt-1"><a href="index.jsp" class="btn-custom px-3 py-2">View Room Details <span class="icon-long-arrow-right"></span></a></p>
    						</div>
    					</div>
    				</div>
						...
						<div id="home" class="video-hero" style="height: 800px; background-image: url(images/bg_1.jpg); background-size:cover; background-position: center center;">
							...
							<div class="container">
								<div class="row justify-content-start d-flex align-items-end height-text ">
									<div class="col-md-8">
										<div class="text">
											<h1>We're Most Recommended HomeStay</h1>
										</div>
									</div>
								</div>
							</div>
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog.jsp" class="block-20" style="background-image: url('images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog.jsp" class="block-20" style="background-image: url('images/image_2.jpg');">
              </a>
              <div class="text mt-3 text-center">
              	<div class="meta mb-2">
                  <div><a href="#">July 03, 2019</a></div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              <a href="blog.jsp" class="block-20" style="background-image: url('images/image_3.jpg');">
              </a>
              <div class="text mt-3 text-center">
              	<div class="meta mb-2">
                  <div><a href="#">July 03, 2019</a></div>
