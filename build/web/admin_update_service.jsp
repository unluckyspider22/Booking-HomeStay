                            ...
                            <div class="col-md-6">
                                <form role="form" method="POST" action="MainController">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="txtServiceId" value="${requestScope.DTO.serviceId}" readonly="true">
                                    </div>
                                    <div class="form-group">
                                        <label>Name</label>
                                    ...
                                    <button type="submit" class="btn btn-primary" name="action" value="UpdateService">Update</button>
                                </form>
                            </div>
                        </div>
                    </div><!-- /.col-->
