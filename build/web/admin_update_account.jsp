                            ...
                            <div class="col-md-6">
                                <form role="form" method="POST" action="MainController">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="txtUsername" value="${requestScope.DTO.username}" readonly="true">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="txtFullname" value="${requestScope.DTO.fullname}">
                                        <font color="red"> ${requestScope.INVALID.fullnameError}</font>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input class="form-control" name="txtEmail" value="${requestScope.DTO.email}">
                                        <font color="red"> ${requestScope.INVALID.emailError}</font>
                                    </div>
                                    <div class="form-group">
                                        <label>Phone</label>
                                        <input class="form-control" name="txtPhone" value="${requestScope.DTO.phone}">
                                        <font color="red"> ${requestScope.INVALID.phoneError}</font>
                                    </div>
                                    <div class="form-group">
                                        <label>IDNumber</label>
                                        <input class="form-control" name="txtIdnumber" value="${requestScope.DTO.idnumber}">
